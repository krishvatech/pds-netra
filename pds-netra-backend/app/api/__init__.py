...
from .v1.zones import router as zones_router
...
api_router.include_router(zones_router, dependencies=protected)
...
api_router.include_router(authorized_users_router, dependencies=[Depends(rate_limit_dependency)])
