  ...
  return (
    <>
      ...
      </header>
      {
        navOpen && (
          <div
            className="fixed inset-0 z-[100] bg-slate-950/95 lg:hidden"
            onClick={() => setNavOpen(false)}
          >
            <aside
              className="absolute left-0 top-0 h-full w-72 max-w-[86vw] border-r border-white/10 bg-slate-900 px-5 py-6 shadow-[20px_0_60px_-15px_rgba(0,0,0,0.8)]"
