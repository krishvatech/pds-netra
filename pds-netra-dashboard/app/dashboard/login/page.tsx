        ...
        <CardContent>
          <form onSubmit={onSubmit} className="space-y-4">
            <div className="space-y-1">
              ...
              <Input id="username" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="e.g. admin or user1" />
            </div>
            <div className="space-y-1">
            ...
            <div className="text-xs text-slate-500">
              Roles are set at registration: Admin or User.
            </div>
            <div className="text-xs text-slate-500">
              New user? <Link className="underline" href="/dashboard/register">Create account</Link>
            </div>
          </form>
        </CardContent>
      </Card>
